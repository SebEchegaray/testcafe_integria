...
SVC_NAME="actions.runner.SebEchegaray-testcafe_integria.Sebastians-MacBook-Pro"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (SebEchegaray-testcafe_integria.Sebastians-MacBook-Pro)"
